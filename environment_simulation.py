...
import time
from modl import collect_gradients, get_coordinated_lambda, gradient_descent_step
from utils.sequence_rl import compute_returns,policy_gradient_loss,policy_entropy_loss,policy_value_loss
def run_sim(env,model,num_steps=1000,epsilon=0.9,stored_steps=[],optimizer=None):
    ...
    return states[0:-1],states[1:],rewards,actions,epsilon,stored_steps