...
from system_model import angle_change_negative_lower_bound,angle_change_positive_upper_bound,\
                            ...
                            acceleration_lower_bound,acceleration_upper_bound,minimum_acceleration,\
                            ...
                            binary_minimum_acceleration,steering_like_previous_lower_bound,steering_like_previous_upper_bound
    ...
    for epoch in range(50):
        ...
        for t in range(100):
            ...
            for step in range(n_steps):
                ...
                binary_acceleration = torch.tanh(steepness*torch.relu(binary_minimum_acceleration(x.squeeze(0),speed_max,0.5)))
                velocity_positive_rhs = minimum_acceleration(binary_acceleration,accel_max/5)
                ...
                acceleration_normalized_constraints_rhs = torch.vstack([acceleration_upper_bound_rhs,acceleration_lower_bound_constraints_rhs,velocity_positive_rhs,
                                                                        acceleration_difference_lower_bound_rhs,acceleration_difference_upper_bound_rhs])
                acceleration_normalized_constraints = torch.vstack([acceleration_upper_bound_constraint,acceleration_lower_bound_constraint,velocity_positive_constraint,
